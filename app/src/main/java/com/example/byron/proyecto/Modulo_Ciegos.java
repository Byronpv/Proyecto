...
public class   Modulo_Ciegos extends AppCompatActivity  implements INICIO.OnFragmentInteractionListener, EDIFICIOS.OnFragmentInteractionListener, SERVICIOS.OnFragmentInteractionListener, SEDES.OnFragmentInteractionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modulo__ciegos);
    ...
    public void onButtonPressed() {
      Intent intent=new Intent(this, Modulo_Ciegos.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_modulo__ciegos, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_modulo__ciegos, container, false);
